...
# Script for running gradient boosting machine models using data from LCP 
# covariate extractions. These models use the caret and CAST packages to
...
# Load in genetic distances and LCP covariate extractions from the 40-km dataset
dat <- readRDS("results/real/extracted_lcp_40_km.rds") %>% 
...
saveRDS(gbm_ffs, "results/real/model_lcp_40_km.rds")
...
# Save predictions to a resistance raster 
raster::writeRaster(pred_rast, "results/real/pred_lcp_40_km.tif", overwrite=T, 
                    datatype = "FLT4S")
